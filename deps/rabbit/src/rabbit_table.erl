     ...
     {rabbit_reverse_route,
      [{record_name, reverse_route},
       ...
       {match, #reverse_route{reverse_binding = reverse_binding_match(),
                              _='_'}}]},
     {rabbit_route_index_1,
      [{record_name, route_index_1},
       {attributes, record_info(fields, route_index_1)},
       {type, bag},
       {match, #route_index_1{source_key = {exchange_name_match(), '_'},
                              destination = binding_destination_match(),
                              _='_'}},
       {storage_properties, [{ets, [{read_concurrency, true}]}]}]},
     {rabbit_route_index_2,
      [{record_name, binding},
       {attributes, record_info(fields, binding)},
       {type, bag},
       {match, #binding{} = binding_match()},
       {storage_properties, [{ets, [{read_concurrency, true}]}]}]},
